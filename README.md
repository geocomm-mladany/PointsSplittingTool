This tool splits a points layer into 3 layers by specifying which points go in which layers, and automatically loads the new points layers into the current project. 
